...
> **Périmètre produit** · deux fonctionnalités ont été **retirées** le 2026-03-07 : l'**annuaire vétérinaire** et le **TNR** (chats libres). Les documents de vision et de roadmap qui les évoquent encore le font au titre de pistes stratégiques, pas de l'état du code.
